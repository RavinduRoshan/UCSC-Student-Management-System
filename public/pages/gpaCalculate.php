    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($errors)){
            ...
            if(!$tableExist){
                ...
                $rows = $database->mysqli_result($database->query("SELECT COUNT(*) FROM `{$id1}`"), 0);

                if (!$rows) {
                    echo '<script language="javascript">';
                    echo 'alert("Sorry!Any result has not been entered to this semester")';
                    echo '</script>';
                }else{
                    $rslt=$new_semgpa->calculate();
                    $rslt=$new_semgpa->calculate_class_gpa();
                }
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-mortar-board fa-fw"></i>  <a href="gpaCalculate.php">Semester GPA</a>
                            </li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="well">
                                        <form id="user_form" action="gpaCalculate.php" method="post" role="form">
                                            <div class="form-group">
                                                <label>Batch</label>
                                            ...
                                            <input class="btn btn-primary" type="submit" name="submit" value="Calculate Semester GPA"></input>
