                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-mortar-board fa-fw"></i>  <a href="view_gpa.php">Semester GPA</a>
                            </li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="well">
                                        <form id="user_form" action="view_gpa.php" method="post" role="form">
                                            <div class="form-group">
                                                <label>Batch</label>
                                            ...
                                            <input class="btn btn-primary" type="submit" name="submit" value="View Semester GPA"></input>
