...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($errors)&&$tableExist1&&$tableExist2&&$tableExist3&&$tableExist4){
            ...
            $new_overallgpa->cal_2nd_degree_GPA();
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-mortar-board fa-fw"></i>  <a href="sp_sel_gpa.php">2nd Year GPA</a>
                            </li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-3">
                                        <form role="form" action="sp_sel_gpa.php">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="well">
                                        <form id="user_form" action="sp_sel_gpa.php" method="post" role="form">
                                            <div class="form-group">
                                                <label>Batch</label>
