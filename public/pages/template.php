                ...
                <div class="col-sm-2"  style="float: right; width:250px; margin-top: 18px;">
                    <div class="panel panel-info navbar-collapse">
                        ...
                        <div class="panel-body">
                            <p><img src="../images/user.jpg" style="width:120px;height:100px; padding-left: 20px"></p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Customers <small>Add Customer</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Add Customer
                            </li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
