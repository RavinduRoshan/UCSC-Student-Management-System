...
<head>
    ...
    <title>UCSC-SMS-administrator-change-password</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-home"></i>  <a href="academic.php">Home</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-user"></i>  <a href="change_pw_aca.php">Change Password</a>
                            </li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="well">
                                        <form id="user_form" action="change_pw_lec.php" method="post" role="form">
                                            <div class="form-group">
